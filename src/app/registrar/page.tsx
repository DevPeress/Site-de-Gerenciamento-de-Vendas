    ...
    return (
        <>
            ...
            <Pagina>
                {loading ? 
                    <>
                        <h1 className="text-center text-[1.5vw] text-gray-500 dark:text-white">Carregando sua empresa...</h1>
                    </> 
                    :  
                    <>
                        {!id || id === 0 ? 
                            ...
                            : 
                            <>
                                <div className="flex absolute items-center justify-center select-none">
