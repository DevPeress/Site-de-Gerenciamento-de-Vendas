...
export default function NotFound() {
    return(
        <div className="flex absolute w-full h-full dark:bg-black top-0 bottom-0 left-0 right-0 m-auto items-center justify-center select-none text-black dark:text-[#FFFFFF]">
            <h1 className="absolute text-[1.5vw] top-[5vw]">404: Página não encontrada!</h1>
            <h2 className="absolute text-[.8vw] top-[8vw]">Ou você tentou alguma rota suspeita ou chegou aqui por engano. Seja qual for, tente usar a navegação</h2>
            <Image
            ...
            <Link href="/inicio" className="flex absolute items-center justify-center bottom-[7vw]">
                <div className="flex absolute w-[10vw] h-[2.5vw] bg-[#5048E5] dark:bg-[#333333] items-center justify-center rounded-[.5vw] hover:scale-110">
                    <Image
