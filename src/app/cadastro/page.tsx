...
export default function Login() { 
    ...
    return (
        <>
            <div className="flex absolute w-full h-full items-center justify-center select-none" style={{ background: dark ? '#000' : '#F9FAFC' }}>
                <div className="flex absolute md:w-[90vw] lg:w-[85.417vw] md:h-[35vw] lg:h-[22.969vw] items-center justify-center">
                    ...
                    <div className="grid grid-cols-2 absolute md:top-[7vw] lg:top-[5vw] md:w-[60vw] lg:w-[50vw] md:h-[20vw] lg:h-[12vw]">
                        <div>
                            ...
                            <h1 className="flex relative md:w-[5vw] lg:w-[4vw] md:bottom-[4.75vw] lg:bottom-[3vw] left-[.5vw] md:text-[1vw] lg:text-[.5vw] text-[#6B7280] dark:text-[#CAFF33] bg-white dark:bg-[#0B0A0A] justify-center">Nome</h1>  
                        </div>
                        ...
                        <div>
                            ...
                            <h1 className="flex relative md:w-[5vw] lg:w-[4vw] md:bottom-[4.75vw] lg:bottom-[3vw] left-[.5vw] md:text-[1vw] lg:text-[.5vw] text-[#6B7280] dark:text-[#CAFF33] bg-white dark:bg-[#0B0A0A] justify-center">Senha</h1>  
                            <Image
                        ...
                        <div>
                            ...
                            <h1 className="flex relative md:w-[5vw] lg:w-[4vw] md:bottom-[4.75vw] lg:bottom-[3vw] left-[.5vw] md:text-[1vw] lg:text-[.5vw] text-[#6B7280] dark:text-[#CAFF33] bg-white dark:bg-[#0B0A0A] justify-center">Email</h1>  
                        </div>

                        <div>
                            <div className="relative md:w-[26vw] lg:w-[21.25vw] md:h-[4vw] lg:h-[2.6vw] rounded border-[#D1D5DB] dark:border-[#CAFF33] border-1 overflow-hidden">
                                <input className="absolute w-[98%] h-full outline-0 p-2 text-center md:text-[1.6vw] lg:text-[.8vw] appearance-none [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none focus:outline-none dark:text-[#FFFFFF]" type="number" value={registro.idade} onChange={(e) => alterarDados('idade',e.target.value)} />
                            </div>
                            <h1 className="flex relative md:w-[5vw] lg:w-[4vw] md:bottom-[4.75vw] lg:bottom-[3vw] left-[.5vw] md:text-[1vw] lg:text-[.5vw] text-[#6B7280] dark:text-[#CAFF33] bg-white dark:bg-[#0B0A0A] justify-center">Idade</h1>  
                        </div>
                        ...
                        <div>
                            ...
                            <h1 className="flex relative md:w-[5vw] lg:w-[4vw] md:bottom-[4.75vw] lg:bottom-[3vw] left-[.5vw] md:text-[1vw] lg:text-[.5vw] text-[#6B7280] dark:text-[#CAFF33] bg-white dark:bg-[#0B0A0A] justify-center">Celular</h1>  
                        </div>
                        ...
                        <div>
                            ...
                            <h1 className="flex relative md:w-[5vw] lg:w-[4vw] md:bottom-[4.75vw] lg:bottom-[3vw] left-[.5vw] md:text-[1vw] lg:text-[.5vw] text-[#6B7280] dark:text-[#CAFF33] bg-white dark:bg-[#0B0A0A] justify-center">RG</h1>  
                        </div>
                    </div>
                        
                    <button className="absolute md:top-[27.5vw] lg:top-[20vw] md:w-[26vw] lg:w-[21.25vw] md:h-[4vw] lg:h-[3vw] bg-[#5048E5] dark:bg-[#333333] rounded text-[#FFFFFF] md:text-[2vw] lg:text-[1vw] items-center justify-center hover:scale-110" onClick={verifyEmail}>Registrar Conta</button>
                </div>
            </div>
        </>
    )
